                                ...
                                <div class="snipcart-item block">
                                    <div class="snipcart-thumb">
                                        <a href="<?= \yii\helpers\Url::to(['product/view', 'id' => $offer->id])?>">
                                            <?= \yii\helpers\Html::img("@web/images/{$offer->img}", ["alt" => "{$offer->title}", "class" => "img-responsive"])?>
                                        </a>
                                        <p><?= $offer->title?></p>
                                        <h4>$<?= $offer->price?>
                                    ...
                                    <div class="snipcart-details top_brand_home_details">
                                        <a href="<?= \yii\helpers\Url::to(['cart/add', 'id' => $offer->id])?>" data-id="<?=$offer->id?>" class="btn btn-primary button add-to-cart">Добавить в корзину</a>
                                    </div>
                                </div>
                            </figure>
                        </div>
